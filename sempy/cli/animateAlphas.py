...
to be located in ./<semForPEREGRINEinput>Alphas

Creats three videos, U.mp4, v.mp4, and w.mp4

Example
-------
animateAlphas <sem.yaml>
...
def main():
    ...
    def animate(i, Tri, alphas, comp):
        nonlocal tcf
        # remove only the contours, leave the rest intact
        # (TriContourSet.collections was removed in matplotlib 3.10)
        tcf.remove()
