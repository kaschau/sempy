...
Example
-------
mpiexec -np <np> semForPEREGRINE <sem.yaml>
...
def main():
    ...
    # Parallel information for each rank (mpi4py initializes MPI on import,
    # calling MPI.Init() again is an error)
    comm = MPI.COMM_WORLD
    rank = comm.Get_rank()
    size = comm.Get_size()
