...
This module contains the means of providing interpolation functions for mean profiles of various flow types.

The goal is to create a interpolation routine that one can pass a y=height above the wall value to, and return the mean velocity at that location. 

The name of this function MUST be *addProfile()*
